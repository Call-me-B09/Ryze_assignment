...
export function Sidebar({ items = ["Dashboard", "Settings", "Profile"] }) {
    return (
        <aside className="w-64 h-full border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-4 flex flex-col gap-2">
            {items.map((item) => (
